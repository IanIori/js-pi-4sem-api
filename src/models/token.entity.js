...
var Token = function () {
    ...
    var Token = _classThis = /** @class */ (function (_super) {
        __extends(Token_1, _super);
        function Token_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.id = __runInitializers(_this, _id_initializers, void 0);
            _this.token = (__runInitializers(_this, _id_extraInitializers), __runInitializers(_this, _token_initializers, void 0));
            _this.refreshToken = (__runInitializers(_this, _token_extraInitializers), __runInitializers(_this, _refreshToken_initializers, void 0));
            _this.expiresAt = (__runInitializers(_this, _refreshToken_extraInitializers), __runInitializers(_this, _expiresAt_initializers, void 0));
            _this.userId = (__runInitializers(_this, _expiresAt_extraInitializers), __runInitializers(_this, _userId_initializers, void 0));
    ...
    (function () {
        ...
        _user_decorators = [(0, typeorm_1.ManyToOne)(function () { return user_entity_1.default; }, function (user) { return user.tokens; })];
